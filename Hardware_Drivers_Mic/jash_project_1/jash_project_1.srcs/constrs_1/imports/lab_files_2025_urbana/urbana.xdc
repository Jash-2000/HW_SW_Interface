# URBANA BOARD CONSTRAINTS V2I1 Updated 8/22/2025 F.B.
...
#set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports {JA[3]}]
#set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {JA[4]}]
#set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports {JA[5]}]
#set_property -dict {PACKAGE_PIN E14 IOSTANDARD LVCMOS33} [get_ports {JA[6]}]
#set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports {JA[7]}]
